...
# setFieldWidth in 1.3.40 is not a standalone function declaration. Add the new
# line-aware implementation explicitly and redirect every Builder width call to it.
...
width_patch=r'''# Width changes affect only the visual line where the field lives.
