...
CSS;
    ...
    public static function fieldLibrary(): array
    {
        return [
            ...
            ['key'=>'full_name','type'=>'text','category'=>'personal','label'=>Text::_('COM_DECAROFORMS_FIELD_FULL_NAME'),'placeholder'=>'','required'=>true],
            ...
            ['key'=>'nationality','type'=>'text','category'=>'personal','label'=>Text::_('COM_DECAROFORMS_FIELD_NATIONALITY'),'placeholder'=>'','required'=>false],
            ...
            ['key'=>'postcode','type'=>'text','category'=>'address','label'=>Text::_('COM_DECAROFORMS_FIELD_POSTCODE'),'placeholder'=>'','required'=>false],
            ['key'=>'city','type'=>'text','category'=>'address','label'=>Text::_('COM_DECAROFORMS_FIELD_CITY'),'placeholder'=>'','required'=>false],
            ['key'=>'country','type'=>'text','category'=>'address','label'=>Text::_('COM_DECAROFORMS_FIELD_COUNTRY'),'placeholder'=>'','required'=>false],
            ['key'=>'organisation','type'=>'text','category'=>'organisation','label'=>Text::_('COM_DECAROFORMS_FIELD_ORGANISATION'),'placeholder'=>'','required'=>false],
            ['key'=>'club','type'=>'text','category'=>'organisation','label'=>Text::_('COM_DECAROFORMS_FIELD_CLUB'),'placeholder'=>'','required'=>false],
            ['key'=>'role','type'=>'text','category'=>'organisation','label'=>Text::_('COM_DECAROFORMS_FIELD_ROLE'),'placeholder'=>'','required'=>false],
            ['key'=>'member_number','type'=>'text','category'=>'organisation','label'=>Text::_('COM_DECAROFORMS_FIELD_MEMBER_NUMBER'),'placeholder'=>'','required'=>false],
            ['key'=>'sport','type'=>'text','category'=>'sport','label'=>Text::_('COM_DECAROFORMS_FIELD_SPORT'),'placeholder'=>'','required'=>false],
            ['key'=>'team_name','type'=>'text','category'=>'sport','label'=>Text::_('COM_DECAROFORMS_FIELD_TEAM_NAME'),'placeholder'=>'','required'=>false],
            ['key'=>'level','type'=>'select','category'=>'sport','label'=>Text::_('COM_DECAROFORMS_FIELD_LEVEL'),'placeholder'=>'','required'=>false,'options'=>[Text::_('COM_DECAROFORMS_OPT_BEGINNER'),Text::_('COM_DECAROFORMS_OPT_INTERMEDIATE'),Text::_('COM_DECAROFORMS_OPT_ADVANCED'),Text::_('COM_DECAROFORMS_OPT_OTHER')]],
            ['key'=>'event_date','type'=>'date','category'=>'event','label'=>Text::_('COM_DECAROFORMS_FIELD_EVENT_DATE'),'placeholder'=>'','required'=>false],
            ['key'=>'arrival_date','type'=>'date','category'=>'event','label'=>Text::_('COM_DECAROFORMS_FIELD_ARRIVAL_DATE'),'placeholder'=>'','required'=>false],
            ['key'=>'departure_date','type'=>'date','category'=>'event','label'=>Text::_('COM_DECAROFORMS_FIELD_DEPARTURE_DATE'),'placeholder'=>'','required'=>false],
            ['key'=>'participants','type'=>'number','category'=>'event','label'=>Text::_('COM_DECAROFORMS_FIELD_PARTICIPANTS'),'placeholder'=>'','required'=>false],
            ['key'=>'subject','type'=>'text','category'=>'message','label'=>Text::_('COM_DECAROFORMS_FIELD_SUBJECT'),'placeholder'=>'','required'=>true],
            ['key'=>'message','type'=>'textarea','category'=>'message','label'=>Text::_('COM_DECAROFORMS_FIELD_MESSAGE'),'placeholder'=>'','required'=>true],
            ['key'=>'notes','type'=>'textarea','category'=>'message','label'=>Text::_('COM_DECAROFORMS_FIELD_NOTES'),'placeholder'=>'','required'=>false],
            ['key'=>'motivation','type'=>'textarea','category'=>'message','label'=>Text::_('COM_DECAROFORMS_FIELD_MOTIVATION'),'placeholder'=>'','required'=>false],
            ['key'=>'attachment','type'=>'file','category'=>'document','label'=>Text::_('COM_DECAROFORMS_FIELD_ATTACHMENT'),'placeholder'=>'','required'=>false],
            ['key'=>'identity_document','type'=>'file','category'=>'document','label'=>Text::_('COM_DECAROFORMS_FIELD_IDENTITY_DOCUMENT'),'placeholder'=>'','required'=>false],
            ['key'=>'photo','type'=>'file','category'=>'document','label'=>Text::_('COM_DECAROFORMS_FIELD_PHOTO'),'placeholder'=>'','required'=>false],
            ['key'=>'payment_proof','type'=>'file','category'=>'document','label'=>Text::_('COM_DECAROFORMS_FIELD_PAYMENT_PROOF'),'placeholder'=>'','required'=>false],
            ...
            ['key'=>'custom_number','type'=>'number','category'=>'custom','label'=>Text::_('COM_DECAROFORMS_FIELD_CUSTOM_NUMBER'),'placeholder'=>'','required'=>false],
            ['key'=>'custom_date','type'=>'date','category'=>'custom','label'=>Text::_('COM_DECAROFORMS_FIELD_CUSTOM_DATE'),'placeholder'=>'','required'=>false],
            ['key'=>'custom_select','type'=>'select','category'=>'custom','label'=>Text::_('COM_DECAROFORMS_FIELD_CUSTOM_SELECT'),'placeholder'=>'','required'=>false,'options'=>[Text::_('COM_DECAROFORMS_OPT_1'),Text::_('COM_DECAROFORMS_OPT_2')]],
            ['key'=>'custom_radio','type'=>'radio','category'=>'custom','label'=>Text::_('COM_DECAROFORMS_FIELD_CUSTOM_RADIO'),'placeholder'=>'','required'=>false,'options'=>[Text::_('COM_DECAROFORMS_OPT_1'),Text::_('COM_DECAROFORMS_OPT_2')]],
            ['key'=>'custom_checkboxes','type'=>'checkboxes','category'=>'custom','label'=>Text::_('COM_DECAROFORMS_FIELD_CUSTOM_CHECKBOXES'),'placeholder'=>'','required'=>false,'options'=>[Text::_('COM_DECAROFORMS_OPT_1'),Text::_('COM_DECAROFORMS_OPT_2')]],
        ];
    }
}
