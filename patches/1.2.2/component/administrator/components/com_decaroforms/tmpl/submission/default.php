...
.df-manage{position:sticky;top:12px;padding:16px}.df-manage h3{margin:0 0 16px;font-size:19px}.df-field{display:flex;flex-direction:column;gap:6px;margin-bottom:14px}.df-field label{font-weight:800}.df-field select,.df-field textarea{width:100%;border:1px solid var(--bs-border-color,#d2dae4);border-radius:6px;background:var(--bs-body-bg,#fff);color:inherit;padding:10px 11px}.df-field textarea{min-height:150px;resize:vertical}.df-note{font-size:12px;color:var(--bs-secondary-color,#667085)}.df-manage .df-btn-primary{width:100%}
